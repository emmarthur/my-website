  ...
  return (
    <div className="container mx-auto px-3 sm:px-4 py-8 sm:py-12 md:py-20">
      <motion.div
        ...
        variants={fadeInUp}
      >
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-bold mb-4 sm:mb-6 bg-gradient-to-r from-deep-sea-blue-100 to-accent-orange bg-clip-text text-transparent font-heading">{t('title')}</h1>
