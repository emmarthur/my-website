  ...
  return (
    <div className="container mx-auto px-4 py-20">
      <motion.div
        ...
        variants={fadeInUp}
      >
        <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-deep-sea-blue-100 to-accent-teal bg-clip-text text-transparent">Media</h1>
        <p className="text-xl text-deep-sea-blue-50 mb-12">
          Videos, photos, and creative content
        </p>
